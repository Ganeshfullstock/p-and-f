...
var fname = createFormElements('First Name', 'text', 'first-name');
var lname = createFormElements('Last Name ', 'text', 'last-name');
var address = createFormElements('address ', 'text', 'address');
var pincode = createFormElements('Pincode ', 'text', 'pincode');
...
function createButton() {
    ...
    btn.innerHTML = 'submit all my inputs';
    btn.type = 'button'
